...
// ─── Admin ────────────────────────────────────────────────────────────────────
// (Helper admin lama DIHAPUS: endpoint/method/auth-nya tidak cocok dengan API
// aktual. Admin dashboard memanggil fetch() langsung ke /api/admin/* dengan cookie
// auth, bukan Bearer token.)
